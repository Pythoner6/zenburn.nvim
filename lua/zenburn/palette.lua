return {
	...
	CursorLineSign = { bg="#393939", bold=true, },
	...
	SignColumn = { bg="#3b3b3b", bold=true, },
	Special = { fg="#cfbfaf", },
	...
	Statement = { fg="#e3ceab", },
	StatusLine = { fg="#dcdccc", bg="#2e2e2e", },
	StatusLineNC = { fg="#dcdccc", bg="#2e2e2e", },
